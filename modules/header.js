...
export function header(params) {
  ...
  spanMain.style.textDecoration = 'none'
  spanWallet.style.textDecoration = 'none'
  spanTrans.style.textDecoration = 'none'

  spanMain.style.color = 'black'
  spanWallet.style.color = 'black'
  spanTrans.style.color = 'black'
  ...
  function openModal() {
    ...
    setTimeout(() => {
           modal.style.background = 'rgb(1, 65, 86)'
    }, 720)
  }
